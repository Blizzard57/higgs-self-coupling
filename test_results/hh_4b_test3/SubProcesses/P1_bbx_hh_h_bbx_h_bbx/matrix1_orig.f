...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WH)
      ...
      CALL FFS4_3(W(1,4),W(1,3),GC_83,MDL_MH, FK_MDL_WH,W(1,5))
      CALL OXXXXX(P(0,5),MDL_MB,NHEL(5),+1*IC(5),W(1,4))
      CALL IXXXXX(P(0,6),MDL_MB,NHEL(6),-1*IC(6),W(1,3))
      CALL FFS4_3(W(1,3),W(1,4),GC_83,MDL_MH, FK_MDL_WH,W(1,6))
      CALL FFS4_3(W(1,1),W(1,2),GC_83,MDL_MH, FK_MDL_WH,W(1,3))
C     Amplitude(s) for diagram number 1
      CALL SSS1_0(W(1,5),W(1,6),W(1,3),GC_69,AMP(1))
      CALL FFS4_2(W(1,1),W(1,5),GC_83,MDL_MB, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 2
      CALL FFS4_0(W(1,3),W(1,2),W(1,6),GC_83,AMP(2))
      CALL FFS4_2(W(1,1),W(1,6),GC_83,MDL_MB, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 3
      CALL FFS4_0(W(1,3),W(1,2),W(1,5),GC_83,AMP(3))
