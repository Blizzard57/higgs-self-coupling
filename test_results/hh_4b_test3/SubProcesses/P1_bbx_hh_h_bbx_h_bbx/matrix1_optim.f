...
C     
C     Process: b b~ > h h WEIGHTED<=4 @1
...
C     
      ...
      PARAMETER (NWAVEFUNCS=40, NCOLOR=1) 
      REAL*8     ZERO
      PARAMETER (ZERO=0D0)
      COMPLEX*16 IMAG1
...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WH)
      ...
      AMP(:,:) = (0d0,0d0)
            CALL IXXXXX(P(0,1),MDL_MB,+1,+1*IC(1),W(1,1)) ! count 9
      CALL IXXXXX(P(0,1),MDL_MB,-1,+1*IC(1),W(1,2)) ! count 9
      CALL OXXXXX(P(0,2),MDL_MB,+1,-1*IC(2),W(1,3)) ! count 65
      CALL OXXXXX(P(0,2),MDL_MB,-1,-1*IC(2),W(1,4)) ! count 65
      ...
      CALL FFS4_3(W(1,7),W(1,5),GC_83,MDL_MH, FK_MDL_WH,W(1,9)) ! count 26
      CALL FFS4_3(W(1,7),W(1,6),GC_83,MDL_MH, FK_MDL_WH,W(1,10)) ! count 26
      CALL FFS4_3(W(1,8),W(1,5),GC_83,MDL_MH, FK_MDL_WH,W(1,11)) ! count 26
      CALL FFS4_3(W(1,8),W(1,6),GC_83,MDL_MH, FK_MDL_WH,W(1,12)) ! count 26
      CALL OXXXXX(P(0,5),MDL_MB,+1,+1*IC(5),W(1,13)) ! count 2
      CALL OXXXXX(P(0,5),MDL_MB,-1,+1*IC(5),W(1,14)) ! count 2
      CALL IXXXXX(P(0,6),MDL_MB,+1,-1*IC(6),W(1,15)) ! count 2
      CALL IXXXXX(P(0,6),MDL_MB,-1,-1*IC(6),W(1,16)) ! count 2
      CALL FFS4_3(W(1,15),W(1,13),GC_83,MDL_MH, FK_MDL_WH,W(1,17)) ! count 26
      CALL FFS4_3(W(1,15),W(1,14),GC_83,MDL_MH, FK_MDL_WH,W(1,18)) ! count 26
      CALL FFS4_3(W(1,16),W(1,13),GC_83,MDL_MH, FK_MDL_WH,W(1,19)) ! count 26
      CALL FFS4_3(W(1,16),W(1,14),GC_83,MDL_MH, FK_MDL_WH,W(1,20)) ! count 26
      CALL FFS4_3(W(1,1),W(1,3),GC_83,MDL_MH, FK_MDL_WH,W(1,21)) ! count 16
      CALL FFS4_3(W(1,2),W(1,4),GC_83,MDL_MH, FK_MDL_WH,W(1,24)) ! count 16
      CALL SSS1P1N_1(W(1,17), W(1,21), GC_69, TMP(1))
      call CombineAmpS(4, 
     &(/27,19,31,23/), 
     & (/9,10,11,12/), 
     & TMP, W, AMP(1,1))
      CALL SSS1P1N_1(W(1,17), W(1,24), GC_69, TMP(1))
      call CombineAmpS(4, 
     &(/43,35,47,39/), 
     & (/9,10,11,12/), 
     & TMP, W, AMP(1,1))
      CALL SSS1P1N_1(W(1,18), W(1,21), GC_69, TMP(1))
      call CombineAmpS(4, 
     &(/25,17,29,21/), 
     & (/9,10,11,12/), 
     & TMP, W, AMP(1,1))
      CALL SSS1P1N_1(W(1,18), W(1,24), GC_69, TMP(1))
      call CombineAmpS(4, 
     &(/41,33,45,37/), 
     & (/9,10,11,12/), 
     & TMP, W, AMP(1,1))
      CALL SSS1P1N_1(W(1,19), W(1,21), GC_69, TMP(1))
      call CombineAmpS(4, 
     &(/28,20,32,24/), 
     & (/9,10,11,12/), 
     & TMP, W, AMP(1,1))
      CALL SSS1P1N_1(W(1,19), W(1,24), GC_69, TMP(1))
      call CombineAmpS(4, 
     &(/44,36,48,40/), 
     & (/9,10,11,12/), 
     & TMP, W, AMP(1,1))
      CALL SSS1P1N_1(W(1,20), W(1,21), GC_69, TMP(1))
      call CombineAmpS(4, 
     &(/26,18,30,22/), 
     & (/9,10,11,12/), 
     & TMP, W, AMP(1,1))
      CALL SSS1P1N_1(W(1,20), W(1,24), GC_69, TMP(1))
      call CombineAmpS(4, 
     &(/42,34,46,38/), 
     & (/9,10,11,12/), 
     & TMP, W, AMP(1,1)) ! count 1
      CALL FFS4_2(W(1,1),W(1,9),GC_83,MDL_MB, FK_ZERO,W(1,25)) ! count 8
      CALL FFS4_2(W(1,1),W(1,10),GC_83,MDL_MB, FK_ZERO,W(1,26)) ! count 8
      CALL FFS4_2(W(1,1),W(1,11),GC_83,MDL_MB, FK_ZERO,W(1,27)) ! count 8
      CALL FFS4_2(W(1,1),W(1,12),GC_83,MDL_MB, FK_ZERO,W(1,28)) ! count 8
      CALL FFS4_2(W(1,2),W(1,9),GC_83,MDL_MB, FK_ZERO,W(1,29)) ! count 8
      CALL FFS4_2(W(1,2),W(1,10),GC_83,MDL_MB, FK_ZERO,W(1,30)) ! count 8
      CALL FFS4_2(W(1,2),W(1,11),GC_83,MDL_MB, FK_ZERO,W(1,31)) ! count 8
      CALL FFS4_2(W(1,2),W(1,12),GC_83,MDL_MB, FK_ZERO,W(1,32)) ! count 8
      CALL FFS4P1N_1(W(1,3), W(1,17), GC_83, TMP(1))
      call CombineAmp(8,
     & (/27,19,31,23,59,51,63,55/), 
     & (/25,26,27,28,29,30,31,32/),
     & TMP, W, AMP(1,2))
      CALL FFS4P1N_1(W(1,3), W(1,18), GC_83, TMP(1))
      call CombineAmp(8,
     & (/25,17,29,21,57,49,61,53/), 
     & (/25,26,27,28,29,30,31,32/),
     & TMP, W, AMP(1,2))
      CALL FFS4P1N_1(W(1,3), W(1,19), GC_83, TMP(1))
      call CombineAmp(8,
     & (/28,20,32,24,60,52,64,56/), 
     & (/25,26,27,28,29,30,31,32/),
     & TMP, W, AMP(1,2))
      CALL FFS4P1N_1(W(1,3), W(1,20), GC_83, TMP(1))
      call CombineAmp(8,
     & (/26,18,30,22,58,50,62,54/), 
     & (/25,26,27,28,29,30,31,32/),
     & TMP, W, AMP(1,2))
      CALL FFS4P1N_1(W(1,4), W(1,17), GC_83, TMP(1))
      call CombineAmp(8,
     & (/11,3,15,7,43,35,47,39/), 
     & (/25,26,27,28,29,30,31,32/),
     & TMP, W, AMP(1,2))
      CALL FFS4P1N_1(W(1,4), W(1,18), GC_83, TMP(1))
      call CombineAmp(8,
     & (/9,1,13,5,41,33,45,37/), 
     & (/25,26,27,28,29,30,31,32/),
     & TMP, W, AMP(1,2))
      CALL FFS4P1N_1(W(1,4), W(1,19), GC_83, TMP(1))
      call CombineAmp(8,
     & (/12,4,16,8,44,36,48,40/), 
     & (/25,26,27,28,29,30,31,32/),
     & TMP, W, AMP(1,2))
      CALL FFS4P1N_1(W(1,4), W(1,20), GC_83, TMP(1))
      call CombineAmp(8,
     & (/10,2,14,6,42,34,46,38/), 
     & (/25,26,27,28,29,30,31,32/),
     & TMP, W, AMP(1,2)) ! count 1
      CALL FFS4_2(W(1,1),W(1,17),GC_83,MDL_MB, FK_ZERO,W(1,33)) ! count 8
      CALL FFS4_2(W(1,1),W(1,18),GC_83,MDL_MB, FK_ZERO,W(1,34)) ! count 8
      CALL FFS4_2(W(1,1),W(1,19),GC_83,MDL_MB, FK_ZERO,W(1,35)) ! count 8
      CALL FFS4_2(W(1,1),W(1,20),GC_83,MDL_MB, FK_ZERO,W(1,36)) ! count 8
      CALL FFS4_2(W(1,2),W(1,17),GC_83,MDL_MB, FK_ZERO,W(1,37)) ! count 8
      CALL FFS4_2(W(1,2),W(1,18),GC_83,MDL_MB, FK_ZERO,W(1,38)) ! count 8
      CALL FFS4_2(W(1,2),W(1,19),GC_83,MDL_MB, FK_ZERO,W(1,39)) ! count 8
      CALL FFS4_2(W(1,2),W(1,20),GC_83,MDL_MB, FK_ZERO,W(1,40)) ! count 8
      CALL FFS4P1N_1(W(1,3), W(1,9), GC_83, TMP(1))
      call CombineAmp(8,
     & (/27,25,28,26,59,57,60,58/), 
     & (/33,34,35,36,37,38,39,40/),
     & TMP, W, AMP(1,3))
      CALL FFS4P1N_1(W(1,3), W(1,10), GC_83, TMP(1))
      call CombineAmp(8,
     & (/19,17,20,18,51,49,52,50/), 
     & (/33,34,35,36,37,38,39,40/),
     & TMP, W, AMP(1,3))
      CALL FFS4P1N_1(W(1,3), W(1,11), GC_83, TMP(1))
      call CombineAmp(8,
     & (/31,29,32,30,63,61,64,62/), 
     & (/33,34,35,36,37,38,39,40/),
     & TMP, W, AMP(1,3))
      CALL FFS4P1N_1(W(1,3), W(1,12), GC_83, TMP(1))
      call CombineAmp(8,
     & (/23,21,24,22,55,53,56,54/), 
     & (/33,34,35,36,37,38,39,40/),
     & TMP, W, AMP(1,3))
      CALL FFS4P1N_1(W(1,4), W(1,9), GC_83, TMP(1))
      call CombineAmp(8,
     & (/11,9,12,10,43,41,44,42/), 
     & (/33,34,35,36,37,38,39,40/),
     & TMP, W, AMP(1,3))
      CALL FFS4P1N_1(W(1,4), W(1,10), GC_83, TMP(1))
      call CombineAmp(8,
     & (/3,1,4,2,35,33,36,34/), 
     & (/33,34,35,36,37,38,39,40/),
     & TMP, W, AMP(1,3))
      CALL FFS4P1N_1(W(1,4), W(1,11), GC_83, TMP(1))
      call CombineAmp(8,
     & (/15,13,16,14,47,45,48,46/), 
     & (/33,34,35,36,37,38,39,40/),
     & TMP, W, AMP(1,3))
      CALL FFS4P1N_1(W(1,4), W(1,12), GC_83, TMP(1))
      call CombineAmp(8,
     & (/7,5,8,6,39,37,40,38/), 
     & (/33,34,35,36,37,38,39,40/),
     & TMP, W, AMP(1,3)) ! count 1
      DO K = 1, NCOMB
        ...
        JAMP(1,1) = AMP( K,1)+AMP( K,2)+AMP( K,3)
