...
C     
C     Process: b b~ > h h HIG<=1 HIW<=1 WEIGHTED<=4 @1
...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WH)
      ...
      CALL FFS2_3(W(1,15),W(1,13),GC_74,MDL_MH, FK_MDL_WH,W(1,17)) ! count 26
      CALL FFS2_3(W(1,15),W(1,14),GC_74,MDL_MH, FK_MDL_WH,W(1,18)) ! count 26
      CALL FFS2_3(W(1,16),W(1,13),GC_74,MDL_MH, FK_MDL_WH,W(1,19)) ! count 26
      CALL FFS2_3(W(1,16),W(1,14),GC_74,MDL_MH, FK_MDL_WH,W(1,20)) ! count 26
      CALL FFS2_3(W(1,1),W(1,3),GC_74,MDL_MH, FK_MDL_WH,W(1,21)) ! count 16
      CALL FFS2_3(W(1,2),W(1,4),GC_74,MDL_MH, FK_MDL_WH,W(1,24)) ! count 16
     ...
     & TMP, W, AMP(1,1)) ! count 1
      CALL FFS2_2(W(1,1),W(1,9),GC_74,MDL_MB, FK_ZERO,W(1,25)) ! count 8
      CALL FFS2_2(W(1,1),W(1,10),GC_74,MDL_MB, FK_ZERO,W(1,26)) ! count 8
      CALL FFS2_2(W(1,1),W(1,11),GC_74,MDL_MB, FK_ZERO,W(1,27)) ! count 8
      CALL FFS2_2(W(1,1),W(1,12),GC_74,MDL_MB, FK_ZERO,W(1,28)) ! count 8
      CALL FFS2_2(W(1,2),W(1,9),GC_74,MDL_MB, FK_ZERO,W(1,29)) ! count 8
      CALL FFS2_2(W(1,2),W(1,10),GC_74,MDL_MB, FK_ZERO,W(1,30)) ! count 8
      CALL FFS2_2(W(1,2),W(1,11),GC_74,MDL_MB, FK_ZERO,W(1,31)) ! count 8
      CALL FFS2_2(W(1,2),W(1,12),GC_74,MDL_MB, FK_ZERO,W(1,32)) ! count 8
      CALL FFS2P1N_1(W(1,3), W(1,17), GC_74, TMP(1))
      call CombineAmp(8,
     & (/27,19,31,23,59,51,63,55/), 
     & (/25,26,27,28,29,30,31,32/),
     & TMP, W, AMP(1,2))
      CALL FFS2P1N_1(W(1,3), W(1,18), GC_74, TMP(1))
      call CombineAmp(8,
     & (/25,17,29,21,57,49,61,53/), 
     & (/25,26,27,28,29,30,31,32/),
     & TMP, W, AMP(1,2))
      CALL FFS2P1N_1(W(1,3), W(1,19), GC_74, TMP(1))
      call CombineAmp(8,
     & (/28,20,32,24,60,52,64,56/), 
     & (/25,26,27,28,29,30,31,32/),
     & TMP, W, AMP(1,2))
      CALL FFS2P1N_1(W(1,3), W(1,20), GC_74, TMP(1))
      call CombineAmp(8,
     & (/26,18,30,22,58,50,62,54/), 
     & (/25,26,27,28,29,30,31,32/),
     & TMP, W, AMP(1,2))
      CALL FFS2P1N_1(W(1,4), W(1,17), GC_74, TMP(1))
      call CombineAmp(8,
     & (/11,3,15,7,43,35,47,39/), 
     & (/25,26,27,28,29,30,31,32/),
     & TMP, W, AMP(1,2))
      CALL FFS2P1N_1(W(1,4), W(1,18), GC_74, TMP(1))
      call CombineAmp(8,
     & (/9,1,13,5,41,33,45,37/), 
     & (/25,26,27,28,29,30,31,32/),
     & TMP, W, AMP(1,2))
      CALL FFS2P1N_1(W(1,4), W(1,19), GC_74, TMP(1))
      call CombineAmp(8,
     & (/12,4,16,8,44,36,48,40/), 
     & (/25,26,27,28,29,30,31,32/),
     & TMP, W, AMP(1,2))
      CALL FFS2P1N_1(W(1,4), W(1,20), GC_74, TMP(1))
      call CombineAmp(8,
     & (/10,2,14,6,42,34,46,38/), 
     & (/25,26,27,28,29,30,31,32/),
     & TMP, W, AMP(1,2)) ! count 1
      CALL FFS2_2(W(1,1),W(1,17),GC_74,MDL_MB, FK_ZERO,W(1,33)) ! count 8
      CALL FFS2_2(W(1,1),W(1,18),GC_74,MDL_MB, FK_ZERO,W(1,34)) ! count 8
      CALL FFS2_2(W(1,1),W(1,19),GC_74,MDL_MB, FK_ZERO,W(1,35)) ! count 8
      CALL FFS2_2(W(1,1),W(1,20),GC_74,MDL_MB, FK_ZERO,W(1,36)) ! count 8
      CALL FFS2_2(W(1,2),W(1,17),GC_74,MDL_MB, FK_ZERO,W(1,37)) ! count 8
      CALL FFS2_2(W(1,2),W(1,18),GC_74,MDL_MB, FK_ZERO,W(1,38)) ! count 8
      CALL FFS2_2(W(1,2),W(1,19),GC_74,MDL_MB, FK_ZERO,W(1,39)) ! count 8
      CALL FFS2_2(W(1,2),W(1,20),GC_74,MDL_MB, FK_ZERO,W(1,40)) ! count 8
      CALL FFS2P1N_1(W(1,3), W(1,9), GC_74, TMP(1))
      call CombineAmp(8,
     & (/27,25,28,26,59,57,60,58/), 
     & (/33,34,35,36,37,38,39,40/),
     & TMP, W, AMP(1,3))
      CALL FFS2P1N_1(W(1,3), W(1,10), GC_74, TMP(1))
      call CombineAmp(8,
     & (/19,17,20,18,51,49,52,50/), 
     & (/33,34,35,36,37,38,39,40/),
     & TMP, W, AMP(1,3))
      CALL FFS2P1N_1(W(1,3), W(1,11), GC_74, TMP(1))
      call CombineAmp(8,
     & (/31,29,32,30,63,61,64,62/), 
     & (/33,34,35,36,37,38,39,40/),
     & TMP, W, AMP(1,3))
      CALL FFS2P1N_1(W(1,3), W(1,12), GC_74, TMP(1))
      call CombineAmp(8,
     & (/23,21,24,22,55,53,56,54/), 
     & (/33,34,35,36,37,38,39,40/),
     & TMP, W, AMP(1,3))
      CALL FFS2P1N_1(W(1,4), W(1,9), GC_74, TMP(1))
      call CombineAmp(8,
     & (/11,9,12,10,43,41,44,42/), 
     & (/33,34,35,36,37,38,39,40/),
     & TMP, W, AMP(1,3))
      CALL FFS2P1N_1(W(1,4), W(1,10), GC_74, TMP(1))
      call CombineAmp(8,
     & (/3,1,4,2,35,33,36,34/), 
     & (/33,34,35,36,37,38,39,40/),
     & TMP, W, AMP(1,3))
      CALL FFS2P1N_1(W(1,4), W(1,11), GC_74, TMP(1))
      call CombineAmp(8,
     & (/15,13,16,14,47,45,48,46/), 
     & (/33,34,35,36,37,38,39,40/),
     & TMP, W, AMP(1,3))
      CALL FFS2P1N_1(W(1,4), W(1,12), GC_74, TMP(1))
      call CombineAmp(8,
     & (/7,5,8,6,39,37,40,38/), 
     & (/33,34,35,36,37,38,39,40/),
