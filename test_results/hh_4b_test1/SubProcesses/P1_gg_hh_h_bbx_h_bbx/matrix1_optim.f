...
C     COLOR DATA
C     
      DATA (CF(i,  1),i=  1,  1) /1.800000000000000d+01/
C     1 T(3,4) T(5,6) Tr(1,2)
C     ----------
C     BEGIN CODE
C     ----------
      if (first) then
     ...
     $   *small_width_treatment)), mdl_WH)
      ...
      AMP(:,:) = (0d0,0d0)
            CALL VXXXXX(P(0,1),ZERO,+1,-1*IC(1),W(1,1)) ! count 1
      CALL VXXXXX(P(0,1),ZERO,-1,-1*IC(1),W(1,2)) ! count 1
      CALL VXXXXX(P(0,2),ZERO,+1,-1*IC(2),W(1,3)) ! count 1
      CALL VXXXXX(P(0,2),ZERO,-1,-1*IC(2),W(1,4)) ! count 1
      ...
      CALL FFS2_3(W(1,7),W(1,5),GC_74,MDL_MH, FK_MDL_WH,W(1,9)) ! count 8
      CALL FFS2_3(W(1,7),W(1,6),GC_74,MDL_MH, FK_MDL_WH,W(1,10)) ! count 8
      CALL FFS2_3(W(1,8),W(1,5),GC_74,MDL_MH, FK_MDL_WH,W(1,11)) ! count 8
      CALL FFS2_3(W(1,8),W(1,6),GC_74,MDL_MH, FK_MDL_WH,W(1,12)) ! count 8
      ...
      CALL FFS2_3(W(1,15),W(1,13),GC_74,MDL_MH, FK_MDL_WH,W(1,17)) ! count 8
      CALL FFS2_3(W(1,15),W(1,14),GC_74,MDL_MH, FK_MDL_WH,W(1,18)) ! count 8
      CALL FFS2_3(W(1,16),W(1,13),GC_74,MDL_MH, FK_MDL_WH,W(1,19)) ! count 8
      CALL FFS2_3(W(1,16),W(1,14),GC_74,MDL_MH, FK_MDL_WH,W(1,20)) ! count 8
      CALL VVS3_3(W(1,1),W(1,3),GC_13,MDL_MH, FK_MDL_WH,W(1,21)) ! count 16
      CALL VVS3_3(W(1,2),W(1,4),GC_13,MDL_MH, FK_MDL_WH,W(1,22)) ! count 16
      CALL SSS1P1N_1(W(1,17), W(1,21), GC_69, TMP(1))
      call CombineAmpS(4, 
     &(/27,19,31,23/), 
     & (/9,10,11,12/), 
     & TMP, W, AMP(1,1))
      CALL SSS1P1N_1(W(1,17), W(1,22), GC_69, TMP(1))
      call CombineAmpS(4, 
     &(/11,3,15,7/), 
     & (/9,10,11,12/), 
     & TMP, W, AMP(1,1))
     ...
     & (/9,10,11,12/), 
     & TMP, W, AMP(1,1))
      CALL SSS1P1N_1(W(1,18), W(1,22), GC_69, TMP(1))
      call CombineAmpS(4, 
     &(/9,1,13,5/), 
     & (/9,10,11,12/), 
     & TMP, W, AMP(1,1))
     ...
     & (/9,10,11,12/), 
     & TMP, W, AMP(1,1))
      CALL SSS1P1N_1(W(1,19), W(1,22), GC_69, TMP(1))
      call CombineAmpS(4, 
     &(/12,4,16,8/), 
     & (/9,10,11,12/), 
     & TMP, W, AMP(1,1))
     ...
     & (/9,10,11,12/), 
     & TMP, W, AMP(1,1))
      CALL SSS1P1N_1(W(1,20), W(1,22), GC_69, TMP(1))
      call CombineAmpS(4, 
     &(/10,2,14,6/), 
     & (/9,10,11,12/), 
     & TMP, W, AMP(1,1)) ! count 1
      DO K = 1, NCOMB
        ...
        JAMP(1,1) = (2.000000000000000D+00)*AMP( K,1)
