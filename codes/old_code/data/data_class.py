...
class GenDataset:
    ...
    '''
    def __init__(self,is_rapid : bool = True):
        '''
    ...
    def load_from_root_file(self, delphes_file : str):
        self.delphes_file = delphes_file
        self.create_arrays()

    def load_from_dataset(self, h5_file : str):
    ...
    def get_arrays(self,input_file : str):
        '''
    ...
    def print_pretty(self,array_type : str,record_no : int = 0):
        '''
    ...
    def sanitize_data(self):
        ...
        for i in self.dataset_dict:
            ...
            if len(lepton_index) != 2 or tot_charge_lepton != 0:
                continue
...
if __name__ == "__main__":
    ...
    s1 = GenDataset()
    s1.load_from_root_file('/home/blizzard/HiggsCoupling/codes/tests/known_datasets/root_file.root')
    s1.create_dataset('test_sets/parton.h5')
    print("INFO : The amount of events generated are : " + str(len(s1.dataset_dict)))
    s1.sanitize_data()
    s1.create_dataset('test_sets/sanitize.h5')
    print("INFO : The amount of events remain after sanitization are : " + str(len(s1.dataset_dict)))
    s1.baseline_cuts()
    s1.create_dataset('test_sets/baseline.h5')
